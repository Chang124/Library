...
public class CategoryControl {
	...
	Parent root =FXMLLoader.load(getClass().getResource("/ui/NewCategory.fxml"));
	Scene scene = new Scene(root);
			
	Stage primaryStage = new Stage();
	primaryStage.setScene(scene);
	primaryStage.setTitle("Add New Category Information");
	...
	Parent root =FXMLLoader.load(getClass().getResource("/ui/UpdateCategory.fxml"));
	Scene scene = new Scene(root);
				
	Stage primaryStage = new Stage();
	primaryStage.setScene(scene);
	primaryStage.setTitle("Update Category Information");

	primaryStage.show();
	}

	// DeleteCategoryClick
	public void DeleteCategoryClick(MouseEvent event) throws IOException {
